...
// PixelPerfect never initializes ECommons, so we ship this tiny equivalent
// instead of pulling in the full library just for localization.
public static class Localization
{
    ...
    public static void Init(string? directory)
    {
        ...
        {
            // Missing or unreadable translation file: silently fall back to English.
        }
    }
